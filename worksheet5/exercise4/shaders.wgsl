...
fn intersect_triangle(r: Ray, hit: ptr<function, HitInfo>, v: array<vec3f, 3>, triIndex: u32) -> bool {
    let e0 = v[1] - v[0];
    let e1 = v[2] - v[0];
    let n = cross(e0, e1);
...
fn intersect_scene(r: ptr<function, Ray>, hit: ptr<function, HitInfo>) -> bool {
    ...
    for (var i = 0u; i < arrayLength(&meshFaces); i = i + 1u) {
        ...
        if intersect_triangle(*r, &tempHit, triangle_v, i) {
